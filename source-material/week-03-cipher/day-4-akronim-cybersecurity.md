...
| Akronim | Kepanjangan | Makna Singkat |
|---------|-------------|---------------|
| **SOC** | Security Operations Center | fitur/Ruang pusat di mana tim Blue Team memantau keamanan 24/7. |
...
| Akronim | Kepanjangan | Makna Singkat |
|---------|-------------|---------------|
| **CIA** | Confidentiality, Integrity, Availability | Tiga suci keamanan siber. (Sudah kita pelajari di W1D3!) |
...
**Jawaban:** Atasanmu meminta **Indicator of Compromise**, yaitu jejak digital atau bukti-bukti spesifik peninggalan *hacker*. Ini bisa be: Alamat IP asal serangan, nama *file malware*, *hash malware*, atau URL mencurigakan. Daftar ini nanti dimasukkan ke *Firewall/SIEM* agar serangan dari sumber yang sama otomatis diblokir di masa depan.
