# 🌀 Week 1 · Day 2: Tiga Pilar Cyber Security

> **Rank**: VOID (Unranked) | **Minggu ke-1**, Hari 2/5 | **Durasi**: ~35 menit

📊 **Progress**: Week 1 · Day 2/5 | VOID Rank (Minggu 1 dari 1) | Overall: 2/120 hari (2%)
...
> 💡 **Analogi**: Bayangkan sebuah kastil. **Red Team** adalah tim yang mencoba menembus pertahanan kastil (untuk menguji keamanannya). **Blue Team** adalah penjaga yang mengawasi setiap pintu dan jendela. **Yellow Team** adalah arsitek yang merancang kastil agar susah ditembus sejak awal.
...
Ketiga pilar ini **saling membutuhkan**. Tanpa Red Team, kita tidak tahu kelemahannya. Tanpa Blue Team, tidak ada yang menjaga. Tanpa Yellow Team, tidak ada yang dibangun.
...
```
✅ Expected: Kamu bisa merasakan perbedaan fokus tiap pilar
...
- [TryHackMe Career Paths](https://tryhackme.com/paths) — Lihat berbagai learning path per pilar
...
*📅 TISS Null Teaming · Week 1 · Day 2 · VOID Rank*
